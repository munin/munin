...
try:
    ...
    while True:
        try:
            try:
                planets = urllib2.urlopen("http://game.planetarion.com/botfiles/planet_listing.txt").readlines()
            except:
                print "Failed gathering planet listing."
                time.sleep(300)
                continue
            try:
                galaxies = urllib2.urlopen("http://game.planetarion.com/botfiles/galaxy_listing.txt").readlines()
            except:
                print "Failed gathering galaxy listing."
                time.sleep(300)
                continue    
            try:
                alliances = urllib2.urlopen("http://game.planetarion.com/botfiles/alliance_listing.txt").readlines()
            except:
