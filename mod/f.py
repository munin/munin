...
class f(loadable.loadable):
    ...
    def execute(self,nick,target,command,user,access,irc_msg):
        ...
        if not s_command:
            ...
            if not new_eta:
                ...
                return 0
            self.cmd_eta(nick,target,f,new_eta)
            ...
            if not new_orig_eta:
                ...
                return 0
            self.cmd_orig_eta(nick,target,f,new_orig_eta)
        elif "delete".startswith(s_command):
            return self.cmd_delete(nick,target,f)
        else:
    ...
    def cmd_eta(self,nick,target,f,when):
    ...
    def cmd_orig_eta(self,nick,target,f,when):
    ...
    def cmd_delete(self,nick,target,f):
