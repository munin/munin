...
class f(loadable.loadable):
    ...
    def execute(self,nick,target,prefix,command,user,access,irc_msg):
        ...
        if not f.load_most_recent(irc_msg.client,self.cursor):
        ...
        if not s_command:
            ...
            if not new_eta:
                ...
                return 0
            self.cmd_eta(nick,target,prefix,f,new_eta)
            ...
            if not new_orig_eta:
                ...
                return 0
            self.cmd_orig_eta(nick,target,prefix,f,new_orig_eta)
        elif "delete".startswith(s_command):
            return self.cmd_delete(nick,target,prefix,f)
        else:
    ...
    def cmd_eta(self,nick,target,prefix,f,when):
    ...
    def cmd_orig_eta(self,nick,target,prefix,f,when):
    ...
    def cmd_delete(self,nick,target,prefix,f):
