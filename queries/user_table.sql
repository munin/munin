...
race char(3) NOT NULL CHECK (race in ('Ter','Cat','Xan','Zik','Etd','Kin','Sly')),
...
type VARCHAR(5) NOT NULL CHECK(type in ('Norm','Pod','Struc','Emp','Steal','Res')),
is_cloaked boolean NOT NULL,
...
race VARCHAR(10) NOT NULL CHECK(race in ('Terran','Cathaar','Xandathrii','Zikonian','Eitraides','Kinthia','Slythonian')),
