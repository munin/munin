...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Planetarion ship stats importer for Munin."
    )
    ...
    parser.add_argument(
        ...
        help="Default: the value of 'Planetarion/current_round' in muninrc (%s)"
        % (default_round),
    )
    parser.add_argument(
        "-u", "--url", default=default_stats, help="Default: %s" % (default_stats)
    )
